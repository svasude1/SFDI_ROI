function api = basicPolygon_sv(h_group,draw_api,positionConstraintFcn)
...
%   Copyright 2007-2014 The MathWorks, Inc.    
  ...
  h_fig = iptancestor_sv(h_group,'figure');
  h_axes = iptancestor_sv(h_group,'axes');
  ...
  dispatchAPI = roiCallbackDispatcher_sv(@getPosition);
  ...
  function startDrag(hSrc,~)
    ...
    [start_x,start_y] = getCurrentPoint_sv(h_axes);
    ...
    drag_up_callback_id = iptaddcallback(h_fig, ...
      ...
      function dragMotion(varargin)
          ...
          [new_x,new_y] = getCurrentPoint_sv(h_axes);      
