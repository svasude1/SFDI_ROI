function api = roiCallbackDispatcher_sv(getPosition)      
...
new_position_callback_functions = makeList_sv;
resize_drag_callback_functions = makeList_sv;
translate_drag_callback_functions = makeList_sv;
